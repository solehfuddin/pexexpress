...
class BackToSenderDeliveryFragment : Fragment(), CallbackClick {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_back_to_sender_delivery, container, false)
        ...
        val activity = DetailBackToSenderActivity()
    ...
    private fun readData(token:String,limit:Int,offset:Int) {
        ...
        provider!!.dataOrderNew(token, 31, limit,offset).observe(viewLifecycleOwner) { res ->
            if (res.success == true) {
    ...
    override fun onItemClicked(
        ...
        val intent = Intent(context, DetailBackToSenderActivity::class.java)
