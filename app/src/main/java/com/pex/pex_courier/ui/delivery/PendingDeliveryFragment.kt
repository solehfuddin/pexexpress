...
class PendingDeliveryFragment : Fragment(), CallbackClick {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_pending_delivery, container, false)
        ...
        val activity = DetailPendingDeliveryActivity()
    ...
    private fun readData(token:String,limit:Int,offset:Int) {
        ...
        provider!!.dataOrderNew(token, 30, limit, offset).observe(viewLifecycleOwner) { res ->
            if (res.success == true) {
    ...
    override fun onItemClicked(
        ...
        val intent = Intent(context, DetailPendingDeliveryActivity::class.java)
