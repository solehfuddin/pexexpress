...
class AfterRequestDeliveryFragment : Fragment(), CallbackClick {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_after_request_delivery, container, false)
        ...
        val activity = DetailFinishDeliveryActivity()
    ...
    private fun readData(token:String,limit:Int,offset:Int) {
        ...
        provider!!.dataOrderNew(token, 10, limit, offset).observe(viewLifecycleOwner) { res ->
            if (res.success == true) {
    ...
    override fun onItemClicked(
        ...
        val intent = Intent(context, DetailFinishDeliveryActivity::class.java)
