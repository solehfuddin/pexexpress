...
class QrcourierViewAdapter(val context: Context, val activity: Activity, private val listener: CallbackClick) :  RecyclerView.Adapter<QrcourierViewAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.card_cu_qr,parent,false)
