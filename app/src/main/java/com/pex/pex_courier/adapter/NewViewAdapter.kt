...
class NewViewAdapter(val context : Context, val activity: Activity, private val listener: CallbackClick) : RecyclerView.Adapter<NewViewAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.cardView.setOnClickListener {
            listener.onItemClicked(it, data, status!!, title!!, position)
        }
    }
